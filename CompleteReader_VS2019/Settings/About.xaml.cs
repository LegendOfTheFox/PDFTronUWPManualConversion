...
namespace CompleteReader.Settings
{
    public sealed partial class About : UserControl
    {
        public About()
        {
            ...
            string version = string.Format("{0}.{1}.{2}", Windows.ApplicationModel.Package.Current.Id.Version.Major, Windows.ApplicationModel.Package.Current.Id.Version.Minor, Windows.ApplicationModel.Package.Current.Id.Version.Build);

            VersionTextBlock.Text = loader.GetString("Settings_About_Version") + " " + version;

            BuildTextBlock.Text = loader.GetString("Settings_About_Build") + " " + Windows.ApplicationModel.Package.Current.Id.Version.Revision;
        }
    }
}
