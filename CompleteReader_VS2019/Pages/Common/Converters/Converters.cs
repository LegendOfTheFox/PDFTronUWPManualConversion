...
namespace CompleteReader.Pages.Common.Converters
{
    ...
    public class BooleanToOpacityParamConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            bool visible = System.Convert.ToBoolean(value);
    ...
    public class StringWithResourceParameterConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
    ...
    public class ReverseBooleanToBackgroundOpacity : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            bool val = (bool)value;
    ...
    public class ReverseBooleanToThicknessConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            bool val = (bool)value;
    ...
    public class BooleanToMaxLengthConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            bool val = (bool)value;
    ...
    public class InverseEnumToBooleanConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            string val = value.ToString();
            string param = parameter as string;
            return string.IsNullOrEmpty(val) || string.IsNullOrEmpty(param) || !val.Equals(param, StringComparison.OrdinalIgnoreCase);
        }
